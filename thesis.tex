...
\usepackage[top=2cm,bottom=2cm,left=2.5cm,right=1.5cm,headsep=10pt,a4paper]{geometry} % Page margins
%\usepackage[top=3cm,bottom=3cm,left=2.5cm,right=2.5cm,a4paper]{geometry} % Page margins
\usepackage{color}
...
\usepackage[cache=false, outputdir=out]{minted} %outputdir needed to work with texpad , outputdir=.texpadtmp
\usepackage{pgfplots}
\usepackage{pgfmath}
